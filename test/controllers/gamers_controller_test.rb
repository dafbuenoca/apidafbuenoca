...
class GamersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gamer" do
    assert_difference('Gamer.count') do
      post gamers_url, params: { gamer: { favourite_game: @gamer.favourite_game, hours_played: @gamer.hours_played, join__age: @gamer.join__age } }
    end
  ...
  test "should update gamer" do
    patch gamer_url(@gamer), params: { gamer: { favourite_game: @gamer.favourite_game, hours_played: @gamer.hours_played, join__age: @gamer.join__age } }
