...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference('Admin.count') do
      post admins_url, params: { admin: { age: @admin.age, exp: @admin.exp, name: @admin.name } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { age: @admin.age, exp: @admin.exp, name: @admin.name } }
